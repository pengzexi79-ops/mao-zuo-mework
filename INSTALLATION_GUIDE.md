...
从公开仓库 `pengzexi79-ops/mao-zuo-mework` 的 `v2.2.165` Release 下载以下文件，并放在同一目录：

- `Mework-Setup-2.2.165.exe`
- 所有同版本 `.bin` 分片
- `SHA256SUMS.txt`
...
```powershell
Get-FileHash .\Mework-Setup-2.2.165.exe -Algorithm SHA256
```
